...
<div class="panel-heading theme-patients"><span class="inlineicon edit-mini">Edit Patient</span></div>
...
<form method="post" action="" enctype="multipart/form-data">
	...
	<div class="form-group"><label>Gender:</label><select class="form-control"  name='gender'  id='gender' size='1' >
    <option value='<?php echo patient_info("gender",$id);?>'><?php echo patient_info("gender",$id);?> (Current)</option>
	...
	<div class="form-group"><label>Age:</label><select class="form-control"  name='age' id='age' size='1'>
			<option value="<?php echo patient_info("age",$id);?>"><?php echo patient_info("age",$id);?> (Current)</option>
