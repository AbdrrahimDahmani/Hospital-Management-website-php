...
function update_branch_profile($guardian,$id,$name,$address,$location,$contact,$type){
	...
	mysqli_query($con, "update p_branches_dir set name='$name',address='$address',location='$location',contact='$contact',type='$type',guardian='$guardian',last_update='$current_time' where id='$id'") or die(mysqli_error($con));
...
mysqli_query($con, "insert into p_branches_dir set name='$name',address='$address',location='$location',contact='$contact',type='$type',guardian='$guardian',last_update='$current_time'																																																							") or die(mysqli_error($con));
...
function branch_delete($id){
	...
	mysqli_query($con, "delete from p_branches_dir where id='$id'") or die(mysqli_error($con));
