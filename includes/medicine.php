...
function medicine_delete($id){
	...
	mysqli_query($con, "delete from p_medicine_dir where id='$id'") or die(mysqli_error($con));
...
function delete_single_stock($id){
	...
	mysqli_query($con, "delete from p_stock where id='$id'") or die(mysqli_error($con));
