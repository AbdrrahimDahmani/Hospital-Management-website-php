	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<?php if (display_permission("medicine_profile") == true) { ?>
				...
				<?php
				$sql = mysqli_query($con, "select * from p_medicine_dir where category='Bottle' order by code asc limit 9000") or die(mysqli_error($con));
			...
			<?php if (display_permission("medicine_profile") == true) { ?>
				...
				<?php
				$sql = mysqli_query($con, "select * from p_medicine_dir where category='Tablets' order by code asc limit 9000") or die(mysqli_error($con));
				while ($medicines = mysqli_fetch_array($sql)) {
				?>
					<a class="nohover" href="profile.php?id=<?php echo $medicines['id'] ?>">
						<div class="panel panel-default profile-card profile-medicines">
			...
			<?php if (display_permission("medicine_profile") == true) { ?>
				...
				<?php
				$sql = mysqli_query($con, "select * from p_medicine_dir where category='Syrup' order by code asc limit 9000") or die(mysqli_error($con));
				while ($medicines = mysqli_fetch_array($sql)) {
				?>
					<a class="nohover" href="profile.php?id=<?php echo $medicines['id'] ?>">
						<div class="panel panel-default profile-card profile-medicines">
