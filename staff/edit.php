		...
		<div class="panel-body">
			...
			?>
				...
				<form method="POST" action="" enctype="multipart/form-data">
					...
					<div class="form-group"><label>Branch:</label>
						<select class="form-control" name='branch' id='branch' size='1' tabindex='1'>
							...
							?>
								<option value='<?php echo $branches_dir['id'] ?>'><?php echo "$global_permission->guardian_short_name";
																					echo $branches_dir['id'] ?> - <?php echo $branches_dir['name'] ?></option>
							<?php } ?>
						</select>
						<br>
				...
				<div id="page-clear" align="center">
					<div id="deleteButton"><a class="delete-me" href="edit.php?id=<?php echo "$profile->id"; ?>&delete">Delete Profile</a></div>
				</div>
