	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<script type="text/javascript">
				...
				function drawVisualization() {
					...
					var data = google.visualization.arrayToDataTable([
						...
						<?php
						$sql = mysqli_query($con, "select * from p_branches_dir order by last_update desc limit 2000") or die(mysqli_error($con));
			...
			<?php if (display_permission("staff_profile") == true) { ?>
				...
				<?php
				$sql = mysqli_query($con, "select * from p_staff_dir where access_level='5' order by first_name asc limit 2000") or die(mysqli_error($con));
					...
					<a class="nohover" href="profile<?php echo $extension; ?>?id=<?php echo $staff['id'] ?>">
						<div class="panel panel-default profile-card profile-branch">
							...
							<div class="panel-body">
								...
								<p><i class="glyphicon glyphicon-user"></i><span class="small_id_icon">ID# <?php echo $staff['id'] ?> — </span><span class="small_level_icon"><?php echo "$global_permission->guardian_short_name";
				...
				<?php
				$sql = mysqli_query($con, "select * from p_staff_dir where access_level='4' order by first_name asc limit 2000") or die(mysqli_error($con));
				while ($staff = mysqli_fetch_array($sql)) {
				?>
					<a class="nohover" href="profile<?php echo $extension; ?>?id=<?php echo $staff['id'] ?>">
						<div class="panel panel-default profile-card profile-branch">
				...
				<?php
				$sql = mysqli_query($con, "select * from p_staff_dir where access_level='3' order by first_name asc limit 2000") or die(mysqli_error($con));
				while ($staff = mysqli_fetch_array($sql)) {
				?>
					<a class="nohover" href="profile<?php echo $extension; ?>?id=<?php echo $staff['id'] ?>">
						<div class="panel panel-default profile-card profile-branch">
