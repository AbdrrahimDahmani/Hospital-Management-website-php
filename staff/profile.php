        ...
        <div class="panel-body">
                ...
                <div class="col-md-10">
                    <table class="table table-striped link-staff">
                        <tbody>
                            <tr>
                                <td>Full Name:</td>
                                <td><a class="staff"><?php echo $profile->full_name; ?></a></td>
                            </tr>
                            <tr>
                                <td>Title:</td>
                            ...
                            <tr>
                                <td>Access Level:</td>
                                <td><?php echo $profile->access_level; ?></td>
                            </tr>
                            <tr>
                                <td>Rank:</td>
                                <td><?php echo access_level2rank($profile->access_level); ?></td>
                            </tr>
                            <tr>
                                <td>Branch ID:</td>
                                <td><?php echo "$global_permission->guardian_short_name";
                                    echo $profile->branch; ?></td>
                            </tr>
                            <tr>
                                <td>Designated Branch:</td>
                                <td><?php echo branch_name($profile->branch); ?></td>
                            </tr>
                            <tr>
                                <td>User ID:</td>
                            ...
                            <?php if (display_permission("mobile_number") == true) { ?><tr>
                                    <td>Mobile Number:</td>
                            ...
                            <?php if (display_permission("address") == true) { ?><tr>
                                    <td>Personal Address:</td>
                                    <td><?php echo $profile->address; ?></td>
                                </tr><?php } ?>
                            <tr>
                                <td>Last Activity:</td>
                                <td><?php echo display_time($profile->last_update); ?></td>
                            </tr>
                            <tr>
                                <td>Log:</td>
                                <td><?php echo no_of_actions($profile->id); ?> activities so far</td>
                            </tr>
                            <tr>
                                <td>Registered by:</td>
                                <td><a class="staff" href="profile<?php echo $extension; ?>?id=<?php echo staff_info("registered_by", $profile->id); ?>"><?php echo staff_info("full_name", staff_info("registered_by", $profile->id)); ?></a></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="panel panel-default push_low">
                ...
                <div class="panel-body panel-log">
                    <?php
                    $log_count = 0;
                    $sql = mysqli_query($con, "select * from p_logs where user='$profile->id' order by id desc limit 5") or die(mysqli_error($con));
