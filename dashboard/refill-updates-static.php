...
$sql = mysqli_query($con, "select * from p_stock where branch='$my_branch' order by last_update desc limit 5") or die(mysqli_error($con));
...
?>
    <div class="med-refill-updates mru_<?php echo $update_counts; ?>">
        <div class="row">
            ...
            <div class="mru-txt"><?php echo $stock['code'] ?> <?php if (display_permission("medicine_profile") == true) {
                                                                    echo " - " . medicine_by_code('name', $stock['code']);
                                                                } ?>
