...
<div id="branch-directory" class="container page">
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<br>
			<?php
			$sql = mysqli_query($con, "select * from p_branches_dir order by last_update desc limit 100") or die(mysqli_error($con));
			while ($clinics = mysqli_fetch_array($sql)) {
			?>
				...
				<a class="nohover" href="profile.php?id=<?php echo $clinics['id'] ?>">
					<div class="panel panel-default profile-card profile-branch">
						<div class="panel-heading _theme-branches">
							<?php echo substr($clinics['name'], 0, 30); ?> - <?php echo "$global_permission->guardian_short_name";
																			echo $clinics['id'] ?> <?php if ($clinics['type'] == "Head Office") {
																																							echo " (Head Office)";
																																						} else {
																																							echo "";
																																						} ?>
