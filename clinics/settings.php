	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			if (isset($_POST['submit'])) {
				...
				if ($portal_name == "" || $guardian_short_name == "" || $guardian_name == "" || $access_level_5 == "" || $access_level_4 == "" || $access_level_3 == "" || $access_level_2 == "" || $access_level_1 == "" || $charge_mode_a == "" || $charge_mode_b == "" || $charge_mode_c == "" || $charge_mode_d == "") {
					$hasError = true;
				}
