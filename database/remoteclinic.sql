...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 30 jan. 2023 à 13:50
...
--
-- Structure de la table `p_branches_dir`
--
...
--
-- Déchargement des données de la table `p_branches_dir`
--
...
(18, '1', 'ibn batota', 'batota', 'Morocco Casablanca', '0807090205', 'Branch', '2023-01-30 17:49:55');

-- --------------------------------------------------------

--
-- Structure de la table `p_global_permissions`
--
...
--
-- Déchargement des données de la table `p_global_permissions`
--
...
('1', 'Heal Cloud', '2.0', 'RC', 'RemoteClinic', '3', '4', '3', '4', '5', '3', '3', '3', '5', '3', '5', '5', '5', '3', '4', '08', '16', '3', '', 'Asia/Karachi', '5', '1', '0.50', '0', 'Super Admin', 'Doctor', 'Triage / Nurse Practitioner', 'Staff Nurse', 'Receptionist', 'Guest', '4', '5', '4', '3', '4', '5', '5', '4', '4', '5', '60', 'DH', 5, 3, 1, 0, '6', '2017-04-05 22:51:06', '168');

-- --------------------------------------------------------

--
-- Structure de la table `p_logs`
--
...
--
-- Déchargement des données de la table `p_logs`
--
...
(1998, '6', '2023-01-30 05:04:24', 'LoggedIn', 'staff', '10'),
(1999, '6', '2023-01-30 15:43:39', 'LoggedIn', 'staff', '10'),
(2000, '6', '2023-01-30 15:45:57', 'registered patient Aboud69 at RC 1', 'patient', '20'),
(2001, '6', '2023-01-30 15:46:42', 'created a report for Aboud69 at RC1', 'report', '20'),
(2002, '6', '2023-01-30 15:46:46', 'opened the report 71', 'report', '10'),
(2003, '6', '2023-01-30 16:01:16', 'updated their profile', 'staff', '30'),
(2004, '6', '2023-01-30 16:03:13', 'updated their profile', 'staff', '30'),
(2005, '6', '2023-01-30 16:03:41', 'updated their profile', 'staff', '30'),
(2006, '6', '2023-01-30 16:45:33', 'registered patient RIDA Sakhsa at RC 1', 'patient', '20'),
(2007, '6', '2023-01-30 16:46:28', 'created a report for RIDA Sakhsa at RC1', 'report', '20'),
(2008, '6', '2023-01-30 16:46:31', 'opened the report 72', 'report', '10'),
(2009, '6', '2023-01-30 16:46:58', 'opened the report 72', 'report', '10'),
(2010, '6', '2023-01-30 16:51:23', 'opened the report 72', 'report', '10'),
(2011, '6', '2023-01-30 16:51:34', 'opened the report 72', 'report', '10'),
(2012, '6', '2023-01-30 16:53:55', 'opened the report 72', 'report', '10'),
(2013, '6', '2023-01-30 16:54:00', 'opened the report 72', 'report', '10'),
(2014, '6', '2023-01-30 16:54:04', 'opened the report 72', 'report', '10'),
(2015, '6', '2023-01-30 16:54:09', 'opened the report 72', 'report', '10'),
(2016, '6', '2023-01-30 16:54:21', 'opened the report 72', 'report', '10'),
(2017, '6', '2023-01-30 16:54:39', 'LoggedOut', 'staff', '10'),
(2018, '6', '2023-01-30 16:56:51', 'LoggedOut', 'staff', '10'),
(2019, '6', '2023-01-30 16:57:55', 'LoggedOut', 'staff', '10'),
(2020, '6', '2023-01-30 16:59:42', 'LoggedOut', 'staff', '10'),
(2021, '6', '2023-01-30 17:00:58', 'LoggedOut', 'staff', '10'),
(2022, '6', '2023-01-30 17:02:10', 'LoggedOut', 'staff', '10'),
(2023, '6', '2023-01-30 17:02:35', 'LoggedOut', 'staff', '10'),
(2024, '1', '2023-01-30 17:43:22', 'LoggedIn', 'staff', '10'),
(2025, '1', '2023-01-30 17:43:59', 'LoggedOut', 'staff', '10'),
(2026, '6', '2023-01-30 17:46:19', 'LoggedIn', 'staff', '10'),
(2027, '6', '2023-01-30 17:48:21', 'updated their profile', 'staff', '30'),
(2028, '6', '2023-01-30 17:48:33', 'LoggedOut', 'staff', '10'),
(2029, '6', '2023-01-30 17:49:19', 'LoggedIn', 'staff', '10'),
(2030, '6', '2023-01-30 17:49:56', 'registered New Clinic Profile for ibn batota (18)', 'branch', '50');

-- --------------------------------------------------------

--
-- Structure de la table `p_medicine_dir`
--
...
--
-- Déchargement des données de la table `p_medicine_dir`
--
...
--
-- Structure de la table `p_med_record`
--
...
--
-- Déchargement des données de la table `p_med_record`
--

INSERT INTO `p_med_record` (`id`, `medicine`, `doses`, `timings`, `days`, `total`, `physician_id`, `report_id`, `last_update`, `total_charge`) VALUES
(123, 'UU30', '1+0+0', 'After Meal', '1', 1, '6', '72', '2023-01-30 16:54:00', '0'),
(124, 'UU30', '1+0+0', 'After Meal', '1', 1, '6', '72', '2023-01-30 16:54:09', '5'),
(125, 'UU30', '1+0+0', 'After Meal', '1', 1, '6', '72', '2023-01-30 16:54:21', '0');

-- --------------------------------------------------------

--
-- Structure de la table `p_patients_dir`
--
...
--
-- Déchargement des données de la table `p_patients_dir`
--
...
(156, 'Male', '16', 'PA', 'Saskha', 'n/a', 'n/a', 'n/a', 'n/a', 'n/a', 'n/a', '1', '25', '2017-04-01 20:54:10', 'Rida'),
...
(159, 'Male', '16', 'PZ', 'Aboud69', '0607080907', 'n/a', 'n/a', 'n/a', 'n/a', 'n/a', '1', '6', '2023-01-30 15:45:57', 'Aboud69'),
(160, 'Male', '21', 'PF', 'RIDA Sakhsa', '0807090205', 'n/a', 'n/a', 'n/a', 'n/a', 'n/a', '1', '6', '2023-01-30 16:45:33', 'RIDA Sakhsa');

-- --------------------------------------------------------

--
-- Structure de la table `p_reports`
--
...
--
-- Déchargement des données de la table `p_reports`
--
...
(71, '159', 'a', NULL, '35', 'AD52', 'ADHD', '0', '6', '6', '', '', '', '2023-01-30 15:46:46', '1', '', ''),
(72, '160', 'a', NULL, '32', 'bo', 'C Asymt', '0', '6', '6', '6', 'UU30 - 1+0+0 (After Meal) for 1 days<br>UU30 - 1+0+0 (After Meal) for 1 days<br>UU30 - 1+0+0 (After Meal) for 1 days<br>', 'die', '2023-01-30 16:54:21', '1', '5', '');

-- --------------------------------------------------------

--
-- Structure de la table `p_staff_dir`
--
...
--
-- Déchargement des données de la table `p_staff_dir`
--
...
(1, 'Saad', 'Irfan', 'Mr. Saad Irfan', 'Mr.', '5', 'saad@domain.ext', 'bd3b535b4f6392dce69c4068b95fae42', '00108090807', '00108090807', 'saadirfan', 'RemoteClinic.io', '1', 'active', '1', '2023-01-30 17:43:22'),
(6, 'Aya', 'Aafifi', 'Miss. Aya Aafifi', 'Miss.', '6', 'admin@domain.ext', 'bd3b535b4f6392dce69c4068b95fae42', '00108090807', '00108090807', 'ian', 'Sidi othman', '1', 'active', '1', '2023-01-30 17:49:19'),
...
--
-- Déchargement des données de la table `p_stock`
--
...
(27, 'UU30', '7', '10', '1', '6', '2023-01-30 16:54:21'),
...
--
-- Index pour la table `p_branches_dir`
--
ALTER TABLE `p_branches_dir`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `p_global_permissions`
--
ALTER TABLE `p_global_permissions`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `p_logs`
--
ALTER TABLE `p_logs`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `p_medicine_dir`
--
ALTER TABLE `p_medicine_dir`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `p_med_record`
--
ALTER TABLE `p_med_record`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `p_patients_dir`
--
ALTER TABLE `p_patients_dir`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `p_reports`
--
ALTER TABLE `p_reports`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `p_staff_dir`
--
ALTER TABLE `p_staff_dir`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `p_stock`
--
ALTER TABLE `p_stock`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT pour la table `p_branches_dir`
--
ALTER TABLE `p_branches_dir`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT pour la table `p_logs`
--
ALTER TABLE `p_logs`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2031;

--
-- AUTO_INCREMENT pour la table `p_medicine_dir`
--
ALTER TABLE `p_medicine_dir`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=111;

--
-- AUTO_INCREMENT pour la table `p_med_record`
--
ALTER TABLE `p_med_record`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=126;

--
-- AUTO_INCREMENT pour la table `p_patients_dir`
--
ALTER TABLE `p_patients_dir`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=161;

--
-- AUTO_INCREMENT pour la table `p_reports`
--
ALTER TABLE `p_reports`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;

--
-- AUTO_INCREMENT pour la table `p_staff_dir`
--
ALTER TABLE `p_staff_dir`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;

--
-- AUTO_INCREMENT pour la table `p_stock`
--
ALTER TABLE `p_stock`
